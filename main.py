...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # Now we can upsample
    decoder_layer1 = tf.layers.conv2d_transpose(conv_1x1_layer7, 
                                                num_classes, 
                                                4, 
                                                2, 
                                                padding='same', 
    ...
    decoder_layer2 = tf.layers.conv2d_transpose(skip_connection1, 
                                                num_classes, 
                                                4, 
                                                2, 
                                                padding='same', 
    ...
    final_layer = tf.layers.conv2d_transpose(skip_connection2, 
                                             num_classes, 
                                             16, 
                                             8, 
                                             padding='same', 
